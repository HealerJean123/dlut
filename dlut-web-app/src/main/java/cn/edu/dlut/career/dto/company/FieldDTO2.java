...
public class FieldDTO2 {
    ...
    public FieldDTO2(UUID id, String fieldUsing, String startDate, String fieldAddress, String fieldRequire, String fieldSize, String auditStatus, String startTime, String endTime, String recName) {
        this.id = id;
