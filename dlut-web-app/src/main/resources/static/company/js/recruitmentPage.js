			...
			success:function(obj){
				...
				if(obj.content==null || obj.content==""){
				    ...
				    $.each(obj.content, function(i,e) {
                        ...
                        inner +='<tr class="text-center"><td>'+$(e)[0].title+'</td><td>'+$(e)[0].auditStatusName+'</td><td>'+publishTime +'</td><td>'+startTime+'</td><td>'+endTime+'</td><td><a href="/app/company/bulletinDetail?id='+$(e)[0].id+'">详情</a></td></tr>';
                	});
				}
